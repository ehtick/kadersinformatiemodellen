...
## Richtlijnen om een OTL op te zetten

@Henk

### Richtlijnen om een woordenboeken op te zetten
...
@Wouter melden dat hier nog geen richtlijnen voor zijn.

## Richtlijnen voor eenmalig registeren, meervoudig gebruik.
Dubbele registraties, overtypen van gegevens en dubbele software ontwikkelingen zijn een bekend probleem. Daarom is het van belang om gezamenlijk te werken met dezelfde gegevens en definities. Daarmee wordt het mogelijk om eenmalig te registreren en meervoudig gebruik mogelijk te maken. 
...
Graag toevoegen:
Informatiemodellen van Geonovum. 
GWSW van Rioned
IMBOR van CROW
Een overzicht van alle standaarden kunt u vinden op: https://www.bimloket.nl/ictstandaarden/

Indien organisaties zelf objecten, begrippen en definities ontwikkeld, dan is het van belang om deze eenduidig te definiëren en om deze middels een woordenboek beschikbaar te stellen volgens de richtlijnen die hier voorgesteld worden.
...
**Richtlijnen**
Unieke codering is noodzakelijk op verschillende niveaus:
•	De objecttyple library (dus het woordenboek of ontologie)
•	De objecten
•	De waardenlijsten die bij sommige objecten van toepassing zijn
•	De waarden in de waardenlijst.
...
1. ontwikkeld worden aan de hand van dezelfde afspraken en richtlijnen;
